...
<%@page import="ModeloDAO.AcudienteDAO"%>
<%@page import="ModeloVO.AcudienteVO"%>
    ...
    <body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu text-center" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a href="#" class="dropdown-item">Mis Datos</a>
        ...
        <div class="container text-white py-4">
            <div class="card rounded-lg m-auto text-center cardStyle p-4" style="background-color: rgba(20,25,30,0.65);">
                <form class="m-auto" action="Acudiente" method="post" style="width: 77%;">
                    ...
                    <%                String idUsu = request.getParameter("idUsu");
                        ...
                        AcudienteVO acudienteVO = new AcudienteVO();
                        AcudienteDAO acudienteDAO = new AcudienteDAO();

                        ArrayList<AcudienteVO> listaDatosAcu = acudienteDAO.listarDatosAcudiente(idUsu);

                        for (int i = 0;
                                i < listaDatosAcu.size();
                                i++) {
                            acudienteVO = listaDatosAcu.get(i);

                    %>
                    <label for="idAcu">ID de Acudiente</label><br>
                    <input type="number" class="form-control" name="txtId" id="idAcu" maxlength="5" readonly value="<%= acudienteVO.getIdAcu()%>"><br>
                    <label for="nombre">Nombre</label><br>
                    <input type="text" class="form-control" name="txtNombre" id="nombre" pattern="[a-zA-Z_ñá-ú]{0,20}" placeholder="No hay datos" maxlength="20" value="<%=acudienteVO.getNombre()%>"><br>
                    <label for="identificacion">Identificación</label><br>
                    <input type="number" class="form-control" name="txtIdentificacion" id="identificacion" required placeholder="No hay datos" maxlength="15" value="<%=acudienteVO.getIdentificacion()%>"><br>
                    <label for="telefono">Teléfono</label><br>
                    <input type="number" class="form-control" name="txtTelefono" id="telefono" maxlength="15" placeholder="No hay datos" value=<%=acudienteVO.getTelefono()%>><br>
                    <br>
                    <%}%>
                    <button class="btn btn-primary">Actualizar</button>
                    <input type="hidden" value="2" name="opcion">
                    <input type="hidden" value="<%= acudienteVO.getIdAcu()%>" name="txtIdUsu"><hr>
                    <%
