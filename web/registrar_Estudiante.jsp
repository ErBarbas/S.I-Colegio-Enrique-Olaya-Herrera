<%-- 
    Document   : registrar_Estudiante
    Created on : 11/08/2019, 01:02:49 PM
    Author     : felipe
--%>
    ...
    <body>
        ...
        <div class="container text-white py-4">
            <div class="card text-center m-auto rounded-lg cardStyle p-4" style="background-color: rgba(20,25,30,0.65);">
                <form class="m-auto" method="post" action="Estudiante" style="width: 77%;">

                    <h1>Registrar Estudiante</h1><hr>

                    <div class="m-auto">
                        <label for="nombre">Nombre</label><br>
                        <input type="text" class="form-control" pattern="[a-zA-Z_ñá-ú]{0,20}" maxlength="20" required name="txtNombre" id="nombre"><br>
                        <label for="apellido">Apellido</label><br>
                        <input type="text" class="form-control" pattern="[a-zA-Z_ñá-ú]{0,20}" maxlength="20" required name="txtApellido" id="apellido"><br>
                        <label for="identificacion">Identificación</label><br>
                        <input type="number" class="form-control" maxlength="10" required name="txtIdentificacion" id="identificacion"><br>
                        <label for="grado">Grado</label><br>
                        <input type="number" class="form-control" maxlength="5" required name="txtGrado" id="grado"><br>
                        <label for="telefono">Teléfono</label><br>
                        <input type="number" class="form-control" maxlength="10" name="txtTelefono" id="telefono"><br>

                        <button class="btn btn-primary">Registrar</button>
                        <input type="hidden" name="opcion" value="1">
                        <input type="hidden" name="hdTipo" value="1">
                        <input type="hidden" name="idProf" value="<%= profDAO.traerIdProfesor(idUsu)%>">
