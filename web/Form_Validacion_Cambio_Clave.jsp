...
<html>
    ...
    <body>
        ...
        <div class="container py-4">
            <div class="card text-center m-auto rounded-lg cardStyle cambioDatos" style="background-color: rgba(20,25,30,0.65);">
                <form class="text-white m-auto" action="SValidsUsu" method="post" style="width: 66%">
                    ...
                    <label for="clave">Introduzca su contraseña actual</label>
                    <input class="form-control" type="password" name="txtClave" id="clave" pattern="[a-zA-Z_ñá-ú0-9]{0,20}" required maxlength="20" autocomplete="off"><br>
                    <label for="newClave">Introduzca su nueva contraseña</label>
                    <input class="form-control" type="password" name="txtNewClave" id="newClave" pattern="[a-zA-Z_ñá-ú0-9]{0,20}" required maxlength="20" autocomplete="off"><br>
                    <button class="btn btn-primary">Cambiar Contraseña</button>
                    <input type="hidden" value="3" name="btnOpcion">
