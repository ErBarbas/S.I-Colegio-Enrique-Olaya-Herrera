<%-- 
    Document   : Vincular_Estudiante
    Created on : 27/08/2019, 02:50:29 PM
    Author     : APRENDIZ
--%>
...
<html>
    ...
    <body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu text-center" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a href="#" class="dropdown-item">Enlazar un nuevo Estudiante</a>
                        </div>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container text-white py-4">
            <div class="card rounded-lg m-auto p-4 text-center cardStyle" style="background-color: rgba(20,25,30,0.65);">
                <form action="Estudiante" method="post">

                    <h1>Vincular Estudiante</h1>
                    <hr>

                    <p>Por favor ingrese el documento de identidad de su Estudiante</p>

                    <div class="m-auto">
                        <label for="identificacion">Identificacion del Estudiante</label><br>
                        <input type="number" name="txtIdentificacion" id="identificacion" required maxlength="10" class="form-control"><br>

                        <button class="btn btn-primary">Enlazar</button>
                        <input type="hidden" value="3" name="opcion">
                        <input type="hidden" value="<%= sesion.getAttribute("idUsu")%>" name="txtIdUsu">
                    </div><hr>
