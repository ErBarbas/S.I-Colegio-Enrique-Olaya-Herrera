    ...
    <body>
        ...
        <div class="container text-white py-4">
            <div class="card rounded-lg m-auto text-center cardStyle p-4" style="background-color: rgba(20,25,30,0.65);">
                ...
                <%                String idAcu = request.getParameter("id");

                    AcudienteVO acudienteVO = new AcudienteVO();
                    AcudienteDAO acudienteDAO = new AcudienteDAO();

                    ArrayList<AcudienteVO> listaDatosAcu = acudienteDAO.listarDatosPerfilAcudiente(idAcu);
                ...
                <input type="text" class="form-control" id="nombre" placeholder="No hay datos" readonly maxlength="20" value="<%=acudienteVO.getNombre()%>"><br>
                <label for="identificacion">Identificación</label><br>
                <input type="number" class="form-control" id="identificacion" required placeholder="No hay datos" maxlength="10" value="<%=acudienteVO.getIdentificacion()%>"><br>
                <label for="telefono">Teléfono</label><br>
                <input type="number" class="form-control" id="telefono" maxlength="10" placeholder="No hay datos" value=<%=acudienteVO.getTelefono()%>><br>
                <br>
                <%}%>
            </div><hr>
        </div>
