...
<html>
    ...
    <body>
        ...
        <div class="container text-white text-center">
            ...
            <a href="registrar_Estudiante.jsp" class="btn btn-primary">Registrar Nuevo Estudiante</a><br><br>
            <table id="table_id" class="table table-striped table-bordered dt-responsive nowrap bg-light text-dark m-auto" style="width: 77%">
                ...
                <tbody>
                    <%
                        ...
                        ArrayList<EstudianteVO> listaEstudiantes = estDAO.listarEstudiantes("1");
                    ...
                    <tr>
                        ...
                        <td>
                            <a id="linkAcu" href="Perfil_Acudiente.jsp?id=<%=estVO.getIdAcu()%>" title="Ver perfil de acudiente"><%=estVO.getIdAcu()%></a>
                        </td>
                        <td>
                            <a href="actualizar_Estudiante.jsp?id=<%=estVO.getIdEst()%>" title="Modificar Estudiante"><i class="fas fa-pencil-alt actions"></i></a>
                            <a href="Consultar_Observador.jsp?idEst=<%= estVO.getIdEst()%>&grado=<%= estVO.getGrado()%>&nombre=<%= estVO.getNombre()%>&apellido=<%= estVO.getApellido()%>" title="Registrar Observacion"><i class="far fa-clipboard"></i></a>
                            <a href="consultar_materias_estudiante.jsp?idEst=<%= estVO.getIdEst() %>" title="Gestionar notas"><i class="fas fa-file-signature"></i></a>
                        </td>
