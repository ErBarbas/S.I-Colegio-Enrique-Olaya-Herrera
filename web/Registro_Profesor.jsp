<%-- 
   Document   : Registro_Profesor
   Created on : 10-ago-2019, 14:17:10
   Author     : Windows 10
--%>
            ...
            <div class="card text-center m-auto rounded-lg cardStyle">
                <form action="Cod_Usu" method="post" class="m-auto" style="width: 44%">
                    ...
                    <hr>
                        ...
                        <input class="form-control" type="text" name="txtUsuario" id="usuario" pattern="[a-zA-Z0-9_ñ]{0,20}" maxlength="20" required autocomplete="off"><br>
                        <label for="clave">Clave</label><br>
                        <input class="form-control" type="password" name="txtClave" id="clave" pattern="[a-zA-Z0-9_ñ]{0,20}" maxlength="20" required autocomplete="off"><br>
                        <label>Codigo de Validacion<input class="form-control" type="password" maxlength="15" name="txtCodigo" required autocomplete="off"></label><br><br>
                        <button class="btn btn-primary">Registrar</button>
                        <input  type="hidden" value="2" name="btnOpcion">
                        <input  type="hidden" value="2" name="tipRol"><br><br>
                        <a href="Java_mail.jsp">Solicitar codigo de registro</a>
                    <hr>
                    <%
